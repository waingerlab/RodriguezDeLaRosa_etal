...
%
% In the narrow version, lines 17 and 66 are adjusted to limit the x-axis

function graph = beeswarmbar_narrow(datacolumns,proximity,lim,points,pointlabels,xspread,pointsize)

groupnum= numel(datacolumns);
figure('Color',[1 1 1],'Position',[100, 100,(75*groupnum)+100,500]); %narrow has +100 instead of +300
...
xlim([0 nscale+(meanwidth*1.5)-.15]); %-.15 narrows right x-axis
